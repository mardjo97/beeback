...
import rs.hexatech.beeback.exception.UsernameAlreadyUsedException;
...
public class ExceptionTranslator extends ResponseEntityExceptionHandler {
  ...
  @ExceptionHandler(rs.hexatech.beeback.exception.DeviceIdForbiddenException.class)
  public ResponseEntity<Object> handleDeviceIdException(Throwable ex, NativeWebRequest request) {
    ProblemDetailWithCause pdCause = customizeProblem((ProblemDetailWithCause) new DeviceIdForbiddenException().getBody(), ex, request);
    return handleExceptionInternal((Exception) ex, pdCause, buildHeaders(ex), HttpStatusCode.valueOf(499), request);
  }
  ...
  private ProblemDetailWithCause getProblemDetailWithCause(Throwable ex) {
    ...
    if (
        ex instanceof rs.hexatech.beeback.exception.EmailAlreadyUsedException
  ...
  private boolean containsPackageName(String message) {
    ...
    return StringUtils.containsAny(message, "org.", "java.", "net.", "jakarta.", "javax.", "com.", "io.", "de.", "rs.hexatech.beeback");
  }
}
