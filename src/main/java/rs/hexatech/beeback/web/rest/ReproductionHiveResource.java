...
public class ReproductionHiveResource {
    ...
    private final ReproductionHiveService reproductionHiveService;
    ...
    public ReproductionHiveResource(
        ...
        ReproductionHiveRepository reproductionHiveRepository
    ) {
        this.reproductionHiveService = reproductionHiveService;
    ...
    public ResponseEntity<ReproductionHiveDTO> createReproductionHive(@Valid @RequestBody ReproductionHiveDTO reproductionHiveDTO)
        ...
        reproductionHiveDTO = reproductionHiveService.save(reproductionHiveDTO);
    ...
    public ResponseEntity<ReproductionHiveDTO> updateReproductionHive(
        ...
        reproductionHiveDTO = reproductionHiveService.update(reproductionHiveDTO);
    ...
    public ResponseEntity<ReproductionHiveDTO> partialUpdateReproductionHive(
        ...
        Optional<ReproductionHiveDTO> result = reproductionHiveService.partialUpdate(reproductionHiveDTO);
    ...
    public ResponseEntity<List<ReproductionHiveDTO>> getAllReproductionHives(
        ...
        Page<ReproductionHiveDTO> page = reproductionHiveService.findAll(pageable);
    ...
    public ResponseEntity<ReproductionHiveDTO> getReproductionHive(@PathVariable("id") Long id) {
        ...
        Optional<ReproductionHiveDTO> reproductionHiveDTO = reproductionHiveService.findOne(id);
    ...
    public ResponseEntity<Void> deleteReproductionHive(@PathVariable("id") Long id) {
        ...
        reproductionHiveService.delete(id);
