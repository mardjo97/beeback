 ...
 */
@Entity
@Table(name = "feeding_hive")
@Cache(usage = CacheConcurrencyStrategy.READ_WRITE)
@SuppressWarnings("common-java:DuplicatedBlocks")
public class FeedingHive implements Serializable {
    ...
    public FeedingHive foodAmount(Double foodAmount) {
    ...
    public FeedingHive externalId(Integer externalId) {
    ...
    public FeedingHive uuid(String uuid) {
        this.setUuid(uuid);
        return this;
    }
    ...
    public FeedingHive dateCreated(Instant dateCreated) {
    ...
    public FeedingHive dateModified(Instant dateModified) {
    ...
    public FeedingHive dateSynched(Instant dateSynched) {
    ...
    public FeedingHive dateDeleted(Instant dateDeleted) {
    ...
    public FeedingHive user(User user) {
        this.setUser(user);
        return this;
    }
    ...
    public FeedingHive hive(Hive hive) {
        this.setHive(hive);
        return this;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof FeedingHive)) {
            return false;
        }
        return getId() != null && getId().equals(((FeedingHive) o).getId());
    }
