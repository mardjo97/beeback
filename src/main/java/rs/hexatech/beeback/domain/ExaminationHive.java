 ...
 */
@Entity
@Table(name = "examination_hive")
@Cache(usage = CacheConcurrencyStrategy.READ_WRITE)
@SuppressWarnings("common-java:DuplicatedBlocks")
public class ExaminationHive implements Serializable {
    ...
    public ExaminationHive id(Long id) {
        this.setId(id);
        return this;
    }
    ...
    public ExaminationHive note(String note) {
        this.setNote(note);
        return this;
    }
    ...
    public ExaminationHive dateExamination(Instant dateExamination) {
        this.setDateExamination(dateExamination);
        return this;
    }
    ...
    public ExaminationHive reminderId(String reminderId) {
    ...
    public ExaminationHive externalId(Integer externalId) {
    ...
    public ExaminationHive uuid(String uuid) {
        this.setUuid(uuid);
        return this;
    }
    ...
    public ExaminationHive dateCreated(Instant dateCreated) {
    ...
    public ExaminationHive dateModified(Instant dateModified) {
    ...
    public ExaminationHive dateSynched(Instant dateSynched) {
    ...
    public ExaminationHive dateDeleted(Instant dateDeleted) {
    ...
    public ExaminationHive user(User user) {
        this.setUser(user);
        return this;
    }
    ...
    public ExaminationHive hive(Hive hive) {
        this.setHive(hive);
        return this;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ExaminationHive)) {
            return false;
        }
        return getId() != null && getId().equals(((ExaminationHive) o).getId());
    }
