...
import rs.hexatech.beeback.config.Constants;
import rs.hexatech.beeback.domain.Authority;
import rs.hexatech.beeback.domain.User;
import rs.hexatech.beeback.exception.EmailAlreadyUsedException;
import rs.hexatech.beeback.exception.InvalidPasswordException;
import rs.hexatech.beeback.exception.UsernameAlreadyUsedException;
import rs.hexatech.beeback.repository.AuthorityRepository;
...
public class UserService {
  ...
  private void clearUserCaches(User user) {
    ...
    Objects.requireNonNull(cacheManager.getCache(UserRepository.USERS_BY_LOGIN_SIMPLE_CACHE)).evict(user.getLogin());
    Objects.requireNonNull(cacheManager.getCache(UserRepository.USERS_BY_EMAIL_CACHE)).evict(user.getEmail());
  }

  public Optional<User> getUserByEmailActivated(String email) {
    return userRepository.findOneByEmailIgnoreCaseAndActivatedTrue(email);
  }
}
