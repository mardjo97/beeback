...
import harvestResolve from './harvest-routing-resolve.service';

describe('Harvest routing resolve service', () => {
  let mockRouter: Router;
  let mockActivatedRouteSnapshot: ActivatedRouteSnapshot;
  let service: HarvestService;
  let resultHarvest: IHarvest | null | undefined;
  ...
  describe('resolve', () => {
    it('should return IHarvest returned by find', () => {
      ...
      TestBed.runInInjectionContext(() => {
        harvestResolve(mockActivatedRouteSnapshot).subscribe({
          next(result) {
    ...
    it('should return null if id is not provided', () => {
      ...
      expect(resultHarvest).toEqual(null);
    });

    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse<IHarvest>({ body: null })));
      mockActivatedRouteSnapshot.params = { id: 123 };
