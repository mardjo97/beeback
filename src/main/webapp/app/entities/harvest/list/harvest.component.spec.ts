...
import { sampleWithRequiredData } from '../harvest.test-samples';
...
describe('Harvest Management Component', () => {
  ...
  describe('trackId', () => {
    it('Should forward to harvestService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getHarvestIdentifier');
      const id = comp.trackId(entity);
      expect(service.getHarvestIdentifier).toHaveBeenCalledWith(entity);
