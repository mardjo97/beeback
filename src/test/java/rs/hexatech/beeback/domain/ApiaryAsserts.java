...
public class ApiaryAsserts {
    ...
    public static void assertApiaryAllPropertiesEquals(Apiary expected, Apiary actual) {
        assertApiaryAutoGeneratedPropertiesEquals(expected, actual);
     ...
     * @param actual the actual entity
     */
    public static void assertApiaryAutoGeneratedPropertiesEquals(Apiary expected, Apiary actual) {
        assertThat(expected)
            .as("Verify Apiary auto generated properties")
